"""Regras de negocio do dominio fitossanidade."""

from __future__ import annotations

from app.fitossanidade.repository import FitossanidadeRepository

class FitossanidadeService:
    """Camada de orquestracao das regras de negocio."""

    def __init__(self, repository: FitossanidadeRepository | None = None) -> None:
        self.repository = repository or FitossanidadeRepository()
