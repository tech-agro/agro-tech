"""Controle do estado de abertura dos diálogos do módulo de estoque.

Como o módulo possui várias entidades independentes (lotes, locais,
estoques, certificações, recebimentos etc.), cada diálogo é isolado por
um escopo (`scope`), evitando interferência entre as abas.
"""
...
_DIALOG_KEY_PREFIX = "estoque_dialog"
